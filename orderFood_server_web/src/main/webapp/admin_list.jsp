						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/admin_add.jsp'">
									...
									<c:forEach items="${admins}" var="admin">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/admin/findById?id=${admin.id}" class="btn bg-olive btn-xs">详情</a>
												<security:authorize access="hasAnyRole({'ROLE_BOSS'})">
												<a href="${pageContext.request.contextPath}/role/findOtherByAdminId?adminId=${admin.id}" class="btn bg-olive btn-xs">添加角色</a>
												</security:authorize>
											</td>
										</tr>
									</c:forEach>
