...
<head>
    ...
    <title>新增产品</title>
    <meta name="description" content="新增产品">
    <meta name="keywords" content="新增产品">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/product_list.jsp">产品管理</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="产品名" name="productName">
                        </div>
